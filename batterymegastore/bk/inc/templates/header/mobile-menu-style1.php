	...
	<div class="side-panel-inner" id="mobile_menu_scroll">
		...
		<div class="mobile-menu-top">
			...
			<form id="bmstore_vrm_search" class="bmstore-vrm-search" action="/batteries" method="GET">
				<span class="gb-icon"><img src="/wp-content/uploads/2020/04/gb-icon_new.png" alt=""></span>
				<input type="text" name="vrm" placeholder="ENTER REG" id="bmstore_search_input-mobile" class="bmstore-search-input">
				<button type="submit"><img src="/wp-content/uploads/2020/04/arrow_new.png" alt=""></button>
			</form>
			...
			if ( 'on' === ot_get_option( 'mobilemenu_override', 'off' ) ) {
				...
				wp_nav_menu(
					array(
						...
						'depth'          => 4,
						'container'      => false,
						'menu_class'     => 'thb-mobile-menu thb-mobile-menu-dropdown',
						'walker'         => new thb_mobileDropdown(),
						'fallback_cb'    => function() {
							?>
			...
			if ( has_nav_menu( 'mobile-secondary-menu' ) ) {
				wp_nav_menu(
					array(
						...
						'depth'          => 2,
						'container'      => false,
						'menu_class'     => 'thb-secondary-menu thb-mobile-menu-dropdown',
						'walker'         => new thb_mobileDropdown(),
					)
				);
			}
