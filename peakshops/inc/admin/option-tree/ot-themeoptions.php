...
function thb_custom_theme_options() {
	...
	$custom_settings = array(
		...
		'settings' => array(
			...
			array(
				'label'   => esc_html__( 'Whatsapp', 'peakshops' ),
			...
			array(
				'label'   => esc_html__( 'Shop Filter Widget Toggle', 'peakshops' ),
				'id'      => 'shop_widget_toggle',
				'type'    => 'on_off',
				'desc'    => esc_html__( 'When enabled, shop filter widgets will have a toggle next to them.', 'peakshops' ),
				'section' => 'shop',
				'std'     => 'off',
			),
			array(
			...
			array(
				'label'     => esc_html__( 'Scroll to tab?', 'peakshops' ),
				'id'        => 'shop_product_tab_scroll',
				'type'      => 'on_off',
				'desc'      => esc_html__( 'If enabled, the browser will scroll to the active tab.', 'peakshops' ),
				'std'       => 'off',
				'condition' => 'shop_product_tab_style:is(style5)',
				'section'   => 'product',
			),
			array(
				'id'      => 'product_tab3',
			...
			array(
				'id'      => 'subheader_tab2',
				'label'   => esc_html__( 'Sub-Header - Center Content', 'peakshops' ),
				'type'    => 'tab',
				'section' => 'subheader',
			),
			...
			array(
				...
				'choices'   => array(
					...
					array(
						'label' => esc_html__( 'Search Form', 'peakshops' ),
						'value' => 'search',
					),
					array(
			...
			array(
				...
				'rows'      => '2',
				'operator'  => 'and',
				'condition' => 'header_left_content:is(custom-content),header_style:is(style2)',
				'section'   => 'header',
			),
			array(
